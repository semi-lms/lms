...
<head>
  ...
  <style>
    ...
    .question { border: 1px solid #ccc; padding:16px; margin-bottom:24px; }
    .nav-btn { padding: 8px 16px; margin:4px; background: #007BFF; color: #fff; text-decoration:none; border-radius:4px; }
    .nav-btn.disabled { background: #aaa; pointer-events: none; }
  </style>
