...
<body>
	<div class="container">
		...
		<div class="main-content">
			<h1>강의 등록</h1>
			<form id="courseInsertForm" action="/admin/insertCourse" method="post">
				<table>
					<tr>
						<th>담당 강사</th>
						<td>
...
$(function() {
	// 폼 제출 기본동작 막고 AJAX만 동작하게!
	$("#courseInsertForm").on("submit", function(e) {
		e.preventDefault(); // 폼 submit 중단
